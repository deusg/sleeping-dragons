...
def draw_counters(eggs_collected, lives):
    ...
    screen.draw.text(f"{eggs_collected}", fontsize=40, pos=(30, HEIGHT - 30), color=FONT_COLOR)
    screen.blit("life-count", (60, HEIGHT - 30))
    screen.draw.text(f"{lives}", fontsize=40, pos=(90, HEIGHT - 30), color=FONT_COLOR)
...
def handle_dragon_collision():
    ...
    reset_required = True
    animate(hero, pos=HERO_START, on_finished=substract_life)
